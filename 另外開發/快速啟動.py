...
button = tk.Button(window, text="世界RPG資料夾", bg="lightgreen", font=("Arial", 14),
                     command=lambda: os.startfile (r"C:\Users\User\Documents\Warcraft III\CustomMapData\TWRPG"))
button.grid(row=0, column=1, padx=20, pady=50)

button = tk.Button(window, text="坦克資料夾", bg="lightgreen", font=("Arial", 14),
                     command=lambda: os.startfile(r"C:\Users\User\Documents\Warcraft III\CustomMapData\Random Ability Tank Defence"))
